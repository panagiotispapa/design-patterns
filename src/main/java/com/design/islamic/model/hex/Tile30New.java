...
public class Tile30New {
    ...
    public static double KB = $H.apply(1.0);
    public static double KC = $H.apply(KB);
    public static double AC = 1 - KC;
    public static double CD = $H.apply(AC);
    public static double AD = $P.apply(AC);
    ...
    public static double KG = $H.apply(KF);
