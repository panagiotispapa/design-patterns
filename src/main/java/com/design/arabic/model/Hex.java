...
public class Hex extends Polygon {
    ...
    public static Function<FinalPointTransition, Sequence<Line>> perimeter(double ratio, Type type) {
    ...
    public static Function<FinalPointTransition, Sequence<Line>> innerTriangles(double ratio, Type type) {
        return type == Type.HOR ?
                p -> p.toLine(
                        ratio,
                        vp(
    ...
    public static Function<FinalPointTransition, Sequence<Line>> diagonalLeftToRightVert(double ratio) {
    ...
    public static Function<FinalPointTransition, Sequence<Line>> diagonalLeftToRightHor(double ratio) {
        return p -> p.toLine(ratio,
                vp(
                        Vertex.DL_H,
                        Vertex.UR_H
    ...
    public static Function<FinalPointTransition, Sequence<Line>> diagonalRightToLeftVert(double ratio) {
        return p -> p.toLine(ratio,
                vp(
                        Vertex.DR_V,
                        Vertex.UL_V
    ...
    public static Function<FinalPointTransition, Sequence<Line>> diagonalRightToLeftHor(double ratio) {
        return p -> p.toLine(ratio,
                vp(
                        Vertex.DR_H,
                        Vertex.UL_H
    ...
    public static Function<FinalPointTransition, Sequence<Line>> diagonalVertical(double ratio) {
        return p -> p.toLine(ratio,
                vp(
                        Vertex.UP,
                        Vertex.DOWN
    ...
    public static Function<FinalPointTransition, Sequence<Line>> diagonalHorizontal(double ratio) {
        return p -> p.toLine(ratio,
                vp(
                        Vertex.RIGHT,
                        Vertex.LEFT
    ...
    public static Function<FinalPointTransition, Sequence<Line>> diagonals(double ratio, Type type) {
        return type == Type.HOR ?
                p -> p.toLine(
                        ratio,
                        vp(
    ...
    public enum Vertex implements Polygon.Vertex {
        ...
        private final CanvasPoint canvasPoint;
        ...
        Vertex(int index, double offset, Type type) {
            this.index = index;
            this.type = type;
            this.canvasPoint = newEdgeAt(index, offset, N);
        }
        ...
        public CanvasPoint getCanvasPoint() {
            return canvasPoint;
        }
