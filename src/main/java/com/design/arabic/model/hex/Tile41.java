...
public class Tile41 {
    ...
    public final static FinalPointTransition A2 = fpt(1, UP);
    ...
    public final static FinalPointTransition G = B.to(KC, UL_H);
    public final static FinalPointTransition I = B.to(KC, LEFT);
    public final static FinalPointTransition J = B.to(KC, DL_H);
    public final static FinalPointTransition L = B.to(KC, DR_H);
    public final static FinalPointTransition M = G.to(KC, UR_H);
    public final static FinalPointTransition P = B.to(KD, UL_V);
    public final static FinalPointTransition Q = B.to(KD, DL_V);
    public final static FinalPointTransition S = B.to(KD, DOWN);
    public final static FinalPointTransition T = B.to(KD, UP);
    ...
    public static Payload getPayloadSimple() {
        ...
        return new Payload.Builder("hex_tile_41",
    ...
    public static DesignHelper getDesignHelper() {
        ...
        return new DesignHelper(Hex.ALL_VERTEX_INDEXES, "hex_tile_41_design")
...
//                .withGridSize(16)
                ...
                .addImportantVertexes(Tile41.class)
                .addSinglePathsLines(
                        gray,
